...
export default function Confidentialite() {
    return (
        <div className="pt-32 min-h-screen bg-dark pb-20">
            <Seo title="Politique de Confidentialité" description="Politique de confidentialité et protection des données personnelles de ROADSTAR." />

            <div className="container max-w-4xl text-neutral-300">
                <h1 className="text-4xl font-bold text-white mb-10">Politique de Confidentialité</h1>
