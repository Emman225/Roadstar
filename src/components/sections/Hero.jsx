...
const slides = [
    {
        ...
        primaryButtonText: "Réserver un véhicule",
    ...
    },
    {
        id: 2,
        image: slide2,
        subtitle: "L'élégance en mouvement",
        ...
        description: "Une flotte prestigieuse pour accompagner vos moments les plus importants. Confort absolu et sécurité garantie.",
        ...
        <div className="relative h-screen w-full overflow-hidden bg-gray-900">
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-white via-white/80 to-transparent sm:via-white/40 mix-blend-hard-light opacity-90" />
                    <div className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/60 to-transparent" />
                </motion.div>
            </AnimatePresence>

            {/* Content Content - Re-animates on slide change */}
            <div className="relative h-full container flex flex-col justify-center pt-20 z-10">
